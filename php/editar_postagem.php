...
if (isset($_GET["id"])) {
    ...
    if ($result && $result->num_rows > 0) {
        ...
        echo"</head>";
        echo"<section>";
        echo "<form action='atualizar_postagem.php?username=" . urlencode($user) . "' method='POST' enctype='multipart/form-data'>";
        ...
        echo "<input type='text' id='tag' name='tag' value='" . $tagAtual . "'><br><br>";
        ...
        echo "<button onclick=\"window.location.href='../pages/postagens.php?username=" . urlencode($user) . "'\">Cancelar</button>";
        echo"</section>";
